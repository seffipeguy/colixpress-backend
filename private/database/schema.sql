...
CREATE TABLE orders (
    ...
    livreur_id INT NULL,
    shop_id INT NULL,
    claimed_by INT NULL COMMENT 'Dispatcher qui a pris la commande',
    claimed_at DATETIME NULL,
    dispatching_company_id INT NULL COMMENT 'Entreprise du dispatcher (auto-rempli au claim)',
    ...
    CONSTRAINT fk_orders_claimed_by FOREIGN KEY (claimed_by) REFERENCES users(id) ON DELETE SET NULL,
    CONSTRAINT fk_orders_dispatching_company FOREIGN KEY (dispatching_company_id) REFERENCES companies(id) ON DELETE SET NULL,
    ...
    INDEX idx_orders_claimed_by (claimed_by),
    INDEX idx_orders_dispatching_company (dispatching_company_id),
